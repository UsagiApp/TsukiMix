...
/**
 * Signature-faithful Mihon preference state model. Extensions compiled against current
 * core-common may reference these nested classes even though older extensions-lib did not.
 */

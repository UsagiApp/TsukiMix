...
abstract class HttpSource : CatalogueSource {
	...
	protected open fun popularMangaRequest(page: Int): Request = throw UnsupportedOperationException("Stub! Have no idea!")
	protected open fun popularMangaParse(response: Response): MangasPage = throw UnsupportedOperationException("Stub! Have no idea!")
	...
	protected open fun searchMangaParse(response: Response): MangasPage = throw UnsupportedOperationException("Stub! Have no idea!")
	protected open fun latestUpdatesRequest(page: Int): Request = throw UnsupportedOperationException("Stub! Have no idea!")
	protected open fun latestUpdatesParse(response: Response): MangasPage = throw UnsupportedOperationException("Stub! Have no idea!")
	protected open fun mangaDetailsParse(response: Response): SManga = throw UnsupportedOperationException("Stub! Have no idea!")
	protected open fun chapterListParse(response: Response): List<SChapter> = throw UnsupportedOperationException("Stub! Have no idea!")
	protected open fun pageListParse(response: Response): List<Page> = throw UnsupportedOperationException("Stub! Have no idea!")
	protected open fun imageUrlParse(response: Response): String = throw UnsupportedOperationException("Stub! Have no idea!")
	...
	protected open fun imageRequest(page: Page): Request {
		val imageUrl = page.imageUrl ?: throw IllegalStateException("Page image URL is missing")
	...
	fun getImageRequest(page: Page): Request = imageRequest(page)
